...
const uint32_t ROWS_PER_PAGE = PAGE_SIZE / ROW_SIZE; // ROW_SIZE is fixed with 3 columns: id, username, email
...
PreparedResult prepare_insert_statement(InputBuffer* input_buffer, Statement* statement) {
...
void read_input(InputBuffer* input_buffer) {
    ...
    input_buffer->buffer[bytes_read - 1] = 0; // ends with '\0'
}
